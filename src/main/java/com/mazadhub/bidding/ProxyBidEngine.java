...
/**
 * Resolves the current winner and current price of an item from the set of
 * standing bids, using the classic proxy-bidding ("automatic bidding") rule
 */
public final class ProxyBidEngine
{
    ...
    /**
     * @param startingPrice the item's starting price (floor for the result)
     * @param standingBids  all current standing bids on the item (may be empty)
     * @return who is winning and at what price
     */
