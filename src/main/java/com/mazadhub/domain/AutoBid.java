...
// A bidder's standing proxy bid on an item: the hidden maximum the system may bid up to on their behalf
@Entity
...
public class AutoBid implements Identifiable
{
    ...
    // the auction this ceiling applies to
    @ManyToOne(fetch=FetchType.LAZY, optional=false)
    @JoinColumn(name="item_id", nullable=false)
    private Item item;

    // the user the system bids for
    @ManyToOne(fetch=FetchType.LAZY, optional=false)
    @JoinColumn(name="bidder_id", nullable=false)
    private User bidder;

    // the hidden ceiling: never bid above this
    ...
    // switched off once the auction closes
    ...
    // Starts automatic bidding for a user up to the given ceiling
