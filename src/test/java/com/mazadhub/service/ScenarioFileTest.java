...
/**
 * Data-driven tests: every {@code .txt} file under
 * {@code src/test/resources/scenarios} describes a full auction as a script,
 * and this class replays it against the real services and checks each
 * {@code EXPECT} line.
 *
 * <p>Adding a new test case means adding a text file — no Java required. Each
 * file appears as its own entry in the test report.
 *
 * <p>Script commands:
 * <pre>
 *   START  &lt;price&gt;              starting price of the auction
 *   BID    &lt;user&gt; &lt;amount&gt;      a manual bid (the amount is that user's maximum)
 *   AUTO   &lt;user&gt; &lt;max&gt;         set / raise a hidden proxy maximum
 *   EXPECT &lt;price&gt; &lt;leader&gt;     assert the current price and who is leading
 *   REJECT &lt;user&gt; &lt;amount&gt;      assert this bid is refused
 * </pre>
