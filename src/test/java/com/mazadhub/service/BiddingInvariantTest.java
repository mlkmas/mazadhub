...
// Randomised ("fuzz") testing: thousands of arbitrary bids from fixed seeds, so every run is repeatable
// Whatever the order, five invariants must hold after every accepted bid
class BiddingInvariantTest
{
    ...
    // Fires 300 random bids per seed and re-checks the five invariants after each one
